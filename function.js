...
const load = (overflow, smoothScroll) => {

    // console.log(overflow, smoothScroll);
    ...
    document.documentElement.style.scrollBehavior = smoothScroll; // add scroll-behavior: smooth to html tag
